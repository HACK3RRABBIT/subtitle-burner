// Small hand-rolled icon set (24x24 viewBox, stroke-based) so the UI doesn't
// need an icon library dependency for a handful of glyphs.
...
export function UploadCloudIcon(props) {
  return (
    <Icon {...props}>
      <path d="M4 14.9A5 5 0 0 1 6 5.3 6 6 0 0 1 17.7 7H18a4 4 0 0 1 1 7.87" />
      <path d="M12 12v9" />
